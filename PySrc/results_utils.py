...
def get_time_from_log(log_path: Union[str, Path], start_pattern: str = ": Snapshot Task: ",
...
class AddressBook:
    ...
    def get_oae_result(self):
        ...
        result['time'] = get_time_from_log(self.snapshot_result_path.parent.joinpath(f"{self.snapshot_name()}.log"))
